...
sshpass -p 'VMware1!' ssh -o StrictHostKeyChecking=no root@172.16.11.101 'esxcli system shutdown poweroff'
sshpass -p 'VMware1!' ssh -o StrictHostKeyChecking=no root@172.16.11.102 'esxcli system shutdown poweroff'
sshpass -p 'VMware1!' ssh -o StrictHostKeyChecking=no root@172.16.11.103 'esxcli system shutdown poweroff'
sshpass -p 'VMware1!' ssh -o StrictHostKeyChecking=no root@172.16.11.104 'esxcli system shutdown poweroff'