...
export customer_connect_email=zarep@vmware.com # your vmware connect email address
export SSOuser=administrator@vsphere.local
export vcf=vcf
export PATCHDETAILS=VCENTER:7.0.3.01400-21477706 # patch details of your choice
